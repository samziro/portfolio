...
const Header = () => {
  return (
    <div className="h-full py-24 gap-6 flex flex-col items-center justify-center">
      <img
      ...
      <h1 className="lg w-3/4 text-center leading-l">
      ...
      <div className="flex items-center gap-10">
        <button className="px-4 py-2 bg-slate-50 ring-1 ring-neutral-400 rounded-full">
          Contact me
        </button>
        <button className="px-4 py-2 bg-slate-50 ring-1 ring-neutral-400 rounded-full flex items-center gap-2">

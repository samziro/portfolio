  ...
  return (
    <div className="h-dvh flex flex-col items-center justify-center gap-4">
      <img
        ...
        alt="me_image"
      />
      <h1 className="md:text-xl text-stone-600">Hello! I am Samuel Ziro</h1>
      <h1 className="md:text-6xl text-stone-600">fronted web developer</h1>
      <h1 className="lg mdw-3/4 text-center leading-loose text-stone-600">

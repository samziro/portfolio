...
const Header = () => {
  return (
    <div className="hero h-svh flex flex-col items-center justify-center gap-4"style={{ backgroundImage: `url(${assets.header_img})` }}>
      <img
        className="w-40 rounded-full bg-slate-50 aspect-square"
        src={me}
        alt="me_image"
      />
      <h1 className="text-lg md:text-xl text-stone-600">Hello! I am Samuel Ziro</h1>
      <h1 className="text-3xl text-center md:text-6xl text-stone-600">fronted web developer</h1>

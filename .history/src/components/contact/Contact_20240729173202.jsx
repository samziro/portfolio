...
const Contact = () => {
  return (
    <div className="h-[80dvh] flex flex-col items-center justify-center gap-4">
      ...
      <div className="grid md:w-[40vw]  md:flex md:place-items-center">
        <div
          className="w-full"
        >
          <input
            className="bg-slate-50 p-2 rounded-md w- ring-1 ring-neutral-400"
            type="text"
        ...
        <div>
          <input
            className="bg-slate-50 p-2 rounded-md ring-1 ring-neutral-400"
            type="email"

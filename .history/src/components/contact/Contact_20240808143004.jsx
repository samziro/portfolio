    ...
    <div className="contact h-[100%] py-4 flex flex-col items-center justify-center gap-8">
      ...
      <form onSubmit={onSubmit} className="grid md:w-[40vw] gap-4">
        ...
        <div className="flex items-start">
          <button
            type="submit"
            className="px-6 py-2 flex items-center justify-center gap-3 cursor-pointer bg-slate-50 text-stone-600 ring-1 ring-neutral-400 rounded-full hover:bg-stone-600 hover:text-slate-50 hover"
          >
            Submit {<FaPaperPlane />} 
          </button>
        </div>

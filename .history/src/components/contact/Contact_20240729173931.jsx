  ...
  return (
    <div className="h-[50dvh] flex flex-col items-center justify-center gap-8">
      ...
      <div className="md:w-[40vw]">
        <textarea
          className="bg-slate-50 p-2 focus:outline-none focus-visible:ring-2 rounded-md w-full ring-1 ring-neutral-400"
          name="text area"
          id=""
          cols="30"
          rows="3"
      ...
      <div className="grid place-items-start">
        <button className="px-6 py-2 focus-within:shadow-lg cursor-pointer bg-slate-50 ring-1 ring-neutral-400 rounded-full">
          Submit
        </button>
      </div>
    </div>

...
const Contact = () => {
  return (
    <div className="h-[50dvh] flex flex-col items-center justify-center gap-8 py-6">
      ...
      <div className="flex items-start">
        <button className="px-6 py-2 cursor-pointer bg-stone-600 hover:bg-stone-700 duration-500 text-slate-50 ring-1 ring-neutral-400 rounded-full">
          Submit
        </button>
      </div>
    </div>

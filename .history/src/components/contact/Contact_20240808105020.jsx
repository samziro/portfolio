...
const Contact = () => {
  ...
  return (
    <div className="contact h-[100%] py-4 flex flex-col items-center justify-center gap-8">
      ...
      <form
        onSubmit={onSubmit}
        className="grid md:w-[40vw]  md:flex md:place-items-center md:gap-4"
      >
      ...
      <div className="flex items-start">
        <button type="submit" className="px-6 py-2 cursor-pointer bg-slate-50 text-stone-600 ring-1 ring-neutral-400 rounded-full">
          Submit
        </button>
      </div>

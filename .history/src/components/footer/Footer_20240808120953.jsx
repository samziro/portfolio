...
const Footer = () => {
  const icons = [<FaGitlab />, <IoLogoLinkedin />, <IoCallSharp />];
  return (
    <div className="grid grid-cols-1 md:flex md:items-center md:justify-between my-4">
      ...
      <ul className="flex items-center justify-center gap-4 list-none text-stone-600">
        <p> Follow me:</p>
        <li className="cursor-pointer text-lg flex items-center justify-center gap-4 hover:scale-105 duration-500">
          {icons.map((icon) => icon)}
        </li>
      </ul>
    </div>

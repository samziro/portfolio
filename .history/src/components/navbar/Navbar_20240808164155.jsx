...
const Navbar = () => {
  ...
  return (
    <nav className="sides text-stone-600 z-10 fixed top-0 w-full py-2 flex items-center justify-e md:flex md:items-center md:justify-between shadow-sm bg-slate-50 font-medium">
      <Link
        to="hero"
        smooth={true}
        offset={0}

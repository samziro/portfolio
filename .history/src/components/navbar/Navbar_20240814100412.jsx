...
const Navbar = () => {
  ...
  return (
    <header className="backdrop-blur-sm bg-slate-50/30 w-full z-10 fixed top-0 py-2 shadow-sm">
      ...
      <div className=" ">
        <ul
          className={`md:hidden absolute top-0 left-2 right-2 mt-16 transition-all duration-500 ease-in-out bg-slate-50 text-stone-600 rounded-lg shadow-lg py-5 px-4 space-y-4 flex flex-col items-center ${
            isMenuOpen ? "right-2" : "opacity-0"
          }`}
        >

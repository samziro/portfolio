...
const Navbar = () => {
  ...
  return (
    <header className="bg-slate-50 w-full z-10 fixed top-0 py-2 shadow-sm">
      <nav className="text-stone-600 flex items-center justify-between md:items-center md:justify-between font-medium">
        {/* Logo */}
        <Link to="hero" smooth={true} offset={0} duration={500} className="text-4xl cursor-pointer">
          S.
        </Link>
        ...
        <ul className="hidden md:flex md:items-center md:gap-8">
          ...
          <NavItem to="about" offset={-180} duration={500}>About</NavItem>
          <NavItem to="services" offset={0} duration={500}>Services</NavItem>
          <NavItem to="projects" offset={-180} duration={500}>Project</NavItem>
        </ul>
      ...
      >
        <NavItem to="hero" offset={0} duration={500} onClick={handleClick}>Home</NavItem>
        <NavItem to="about" offset={-130} duration={500} onClick={handleClick}>About</NavItem>
        <NavItem to="services" offset={0} duration={500} onClick={handleClick}>Services</NavItem>
        <NavItem to="projects" offset={-130} duration={500} onClick={handleClick}>Project</NavItem>
        <button
          className="ring-1 ring-neutral-400 px-4 py-1 rounded-full hover:bg-stone-600 hover:text-slate-50 transition duration-500"
          aria-label="Contact me"
        >
          <Link to="contact" smooth={true} offset={-130} duration={500} onClick={handleClick}>
            Contact Me
          </Link>
        </button>
      </ul>

...
const Navbar = () => {
  ...
  return (
    <nav className="sides text-stone-600 z-10 fixed top-0 w-full py-2 md:flex md:items-center md:justify-between shadow-sm bg-slate-50 font-medium">
      ...
      <ul
        className={`links ${isMenuOpen ? 'block' : 'hidden'} md:flex md:items-center md:gap-8 list-none md:pb-0 pb-4`}
      >
        <li>
        ...
        <li>
          <Link to="services" smooth={true} offset={0} duration={500} className="cursor-pointer">
            Services
          </Link>
        </li>
        <li>
          <Link to="project" smooth={true} offset={-160} duration={500} className="cursor-pointer">
            Projects
          </Link>
        </li>
      </ul>

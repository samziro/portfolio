...
const Navbar = () => {
  ...
  return (
    <header className="bg-slate-50 w-full z-10 fixed top-0 py-2 shadow-sm">
      ...
      {/* Mobile Menu */}
      <ul
        className={`text-stone-600 space-y-4 px-4 bg-slate-50 rounded-lg shadow-lg mt-16 py-5 fixed top-0 left-2 right-2 transition-all duration-500 ease-in flex flex- ${

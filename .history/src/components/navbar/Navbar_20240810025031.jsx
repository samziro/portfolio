...
const Navbar = () => {
  ...
  return (
    <header className=" bg-slate-50 w-full z-10 fixed top-0">
      <nav className="sides text-stone-600  w-full py-2 flex items-center justify-between md:flex md:items-center md:justify-between shadow-sm font-medium">
        <div>
          <Link
            to="hero"
            smooth={true}

...
const Navbar = () => {
  ...
  return (
    <header className="bg-slate-50 w-full z-10 fixed top-0 py-2 shadow-sm">
      ...
      {/* Mobile Menu */}
      <div
  className={`fixed top-0 left-2 right-2 mt-16 transition-all duration-500 ease-in ${
    isMenuOpen ? 'right-0' : '-right-[300px]'
  }`}
>
  <ul
    className="bg-slate-50 text-stone-600 rounded-lg shadow-lg py-5 px-4 space-y-4 flex flex-col items-center"
  >
    ...
    <NavItem to="projects" offset={-130} duration={500} onClick={handleClick}>
      Projects
    </NavItem>
    <button

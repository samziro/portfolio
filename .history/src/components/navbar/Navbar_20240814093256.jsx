...
const Navbar = () => {
  ...
  return (
    <header className="bg-slate-50 w-full z-10 fixed top-0 py-2 shadow-sm">
      ...
      {/* Mobile Menu */}
      <div
        className={`absolute top-0 left-2 right-2 mt-16 transition-all bg-slate-50 duration-500 ease-in ${
          isMenuOpen ? "right-0" : "-right-[600px]"
        }`}
      >
        <ul className={`` text-stone-600 rounded-lg shadow-lg py-5 px-4 space-y-4 flex flex-col items-center``}>

...
const Navbar = () => {
  ...
  return (
    <header className="backdrop-blur-sm bg-slate-50/30 w-full z-10 fixed top-0 py-2 shadow-sm">
      ...
      <div>
        <ul
          className={`absolute top-0 left-2 right-2 mt-16 transition-all backdrop-blur-sm bg-slate-50 duration-500 ease-in text-stone-600 rounded-lg shadow-lg py-5 px-4 space-y-4 flex flex-col items-center ${

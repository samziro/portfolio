...
const About = () => {
  ...
  return (
    <div className="about h-[100%] py-4 grid grid-cols-1 md:grid-cols-2 place-content-center gap-6">
      ...
      <div className="flex flex-col md:gap-4 items-start ga justify-between">
        ...
        <div className="qualification grid grid-cols-1 pt-2 md:grid-cols-3 gap-6">
          {qualification.map((qualification) => (
            <div
              key={qualification}
              className="md:flex md:flex-col items-start justify-between ring-1 ring-neutral-400 p-3 rounded-lg md:aspect-square cursor-pointer hover:scale-105 duration-500 hover:shadow-md"
            >
        ...
        <div className='flex flex-col pt-4 md:pt-1 gap-2'>
        ...
        <p className="text-stone-600 flex items-center justify-center gap-2">
          <img className="w-8" src={web_icon} alt="" />
          Web Design and Development
        </p>
        <p className="text-stone-600">UI/UX Design</p>
        <p className="text-stone-600">Graphics Design</p></div>
      </div>
    </div>
  );
}

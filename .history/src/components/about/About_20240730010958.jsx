...
import web_icon from '../../assets/browse.png'
      ...
      <div className="flex flex-col items-start justify-between">
        ...
        <div className="qualification grid grid-cols-3 gap-7">
          {qualification.map((qualification) => (
            <div
              key={qualification}
              className="flex flex-col items-start justify-between ring-1 ring-neutral-400 p-3 rounded-lg aspect-square cursor-pointer hover:-translate-y-1 duration-500 hover:shadow-md"
            >
        ...
        <p className="text-stone-600 flex items-center justify-center gap-6"><img className='w-8' src={web_icon} alt="" />Web Design and Development</p>

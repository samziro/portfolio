  ...
  return (
    <div className="grid grid-cols-2 place-content-center gap-6">
      ...
      <div className="flex flex-col items-start justify-between">
        ...
        <h1 className="font-medium text-stone-700">What I do</h1>
        <p className="text-stone-600">Web Design and Development</p>
        <p className="text-stone-600">UI/UX</p>
        <p cl>Graphics Design</p>
      </div>
    </div>
  );
}

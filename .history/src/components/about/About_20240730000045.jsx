  ...
  return (
    <div className="grid grid-cols-2 place-content-center gap-6">
      ...
      <div>
        ...
        <div className="qualification grid grid-cols-3 gap-4">
          {qualification.map((qualification) => (
            <div
              key={qualification}
              className="flex flex-col items-start justify-between ring-1 ring-neutral-400 p-3 rounded-lg"
            >
              <img className='w-6' src={qualification.image} alt="" />
              <h1 className='font'>{qualification.heading}</h1>

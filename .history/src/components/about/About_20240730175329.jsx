      ...
      <div className="flex flex-col items-start justify-between">
        ...
        <div className="qualification grid grid-cols-1 md:grid-cols-3 gap-7">
          {qualification.map((qualification) => (
            <div
              key={qualification}
              className="md:flex md:flex-col items-start justify-between ring-1 ring-neutral-400 p-3 rounded-lg aspect-square cursor-pointer hover:-translate-y-1 duration-500 hover:shadow-md"
            >

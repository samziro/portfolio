      ...
      <div className="flex flex-col md:gap-4 items-start gap-6 justify-between">
        ...
        <div className="qualification grid grid-cols-1 md:grid-cols-3 gap-6">
          {qualification.map((qualification) => (
            <div
              key={qualification}
              className="md:flex md:flex-col items-start justify-between r p-3 rounded-lg md:aspect-square cursor-pointer hover:scale-105 duration-500 hover:shadow-md md:bg-slate-50"
            >
              <img
